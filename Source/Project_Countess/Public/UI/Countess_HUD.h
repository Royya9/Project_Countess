...
public:
	...
	FORCEINLINE UCountess_WMagic_Menu_Widget* Get_Countess_WMagic_Menu_Widget() { return WMagic_Menu_Widget; }
	...
	bool CreateWMagicMenuWidget(APlayerController* PlayerController, ESlateVisibility Visibility = ESlateVisibility::Visible);
...
private:
	...
	UPROPERTY()
	UCountess_WMagic_Menu_Widget* WMagic_Menu_Widget;
