...
#include "Countess_GAGrantingActor_Lens.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_COUNTESS_API ACountess_GAGrantingActor_Lens : public ACountess_GAGrantingActor_Base
{
	GENERATED_BODY()

public:

    ACountess_GAGrantingActor_Lens();
