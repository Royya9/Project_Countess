...
#include "Countess_GAGrantingActor_Fball.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_COUNTESS_API ACountess_GAGrantingActor_Fball : public ACountess_GAGrantingActor_Base
{
	GENERATED_BODY()

public:

	ACountess_GAGrantingActor_Fball();
