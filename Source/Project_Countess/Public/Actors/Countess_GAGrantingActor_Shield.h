...
#include "Countess_GAGrantingActor_Shield.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_COUNTESS_API ACountess_GAGrantingActor_Shield : public ACountess_GAGrantingActor_Base
{
	GENERATED_BODY()

public:

	ACountess_GAGrantingActor_Shield();
