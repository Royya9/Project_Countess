...
#include "Countess_GAGrantingActor_BDash.generated.h"
 ...
 */
UCLASS()
class PROJECT_COUNTESS_API ACountess_GAGrantingActor_BDash : public ACountess_GAGrantingActor_Base
{
	GENERATED_BODY()

public:

	ACountess_GAGrantingActor_BDash();
