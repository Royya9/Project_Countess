...
#include "Countess_GAGrantingActor_ABlast.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_COUNTESS_API ACountess_GAGrantingActor_ABlast : public ACountess_GAGrantingActor_Base
{
	GENERATED_BODY()
	
public:

	ACountess_GAGrantingActor_ABlast();
