...
UCountess_GE_Mist_CoolDown::UCountess_GE_Mist_CoolDown()
{
	...
	if (AbilityDetailsTable)
	{
		...
		CurveTableRowHandle.RowName = FName("MistAbilityCooldown");
	...
	InheritableOwnedTagsContainer.AddTag(CountessTags::FCooldownTags::MistAbilityCooldownTag);
	InheritableGameplayEffectTags.AddTag(CountessTags::FCooldownTags::MistAbilityCooldownTag);
}
