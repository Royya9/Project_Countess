...
UCountess_GE_ArcBlast_CoolDown::UCountess_GE_ArcBlast_CoolDown()
{
	...
	if (AbilityDetailsTable)
	{
		...
		CurveTableRowHandle.RowName = FName("ArcticBlastCooldown");
	...
	InheritableOwnedTagsContainer.AddTag(CountessTags::FCooldownTags::ArcticBlastAbilityCooldownTag);
	InheritableGameplayEffectTags.AddTag(CountessTags::FCooldownTags::ArcticBlastAbilityCooldownTag);
}
