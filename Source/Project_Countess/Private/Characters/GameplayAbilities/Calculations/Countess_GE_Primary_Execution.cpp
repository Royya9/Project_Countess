...
UCountess_GE_Primary_Execution::UCountess_GE_Primary_Execution()
{
    ...
    RelevantAttributesToCapture.Add(Countess_Statics_Primary().DamageMultiplierDef);
    ...
    FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	(ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(Countess_Statics_Primary().DamageMultiplierDef, EvaluationParameters, DamageMultiplierValue)); // Get Health Snapshot from AttributeSet
	...
	const float UnMitigatedDamage = PrimaryAbilityDamage * DamageMultiplierValue;
