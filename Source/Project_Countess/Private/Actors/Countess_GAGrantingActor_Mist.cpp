...
#include "Actors/Countess_GAGrantingActor_Mist.h"
...
ACountess_GAGrantingActor_Mist::ACountess_GAGrantingActor_Mist()
{
	...
	AbilityToGrant = UCountess_GameplayAbility_Mist::StaticClass();

	bAcquired_Ability = false;
}

void ACountess_GAGrantingActor_Mist::AbilityAcquired(TSubclassOf<UCountess_GameplayAbility_Base> AcquiredAbility)
{
...
void ACountess_GAGrantingActor_Mist::AbilityAcquiredEvent_Implementation()
{
	AbilityAcquiredEvent();
}

bool ACountess_GAGrantingActor_Mist::IsAbilityAcquired() const
{
	return bAcquired_Ability;
}

UBoxComponent* ACountess_GAGrantingActor_Mist::GetBoxComponent() const
{
	return BoxComponent_HardRef;
}

TSubclassOf<UCountess_GameplayAbility_Base> ACountess_GAGrantingActor_Mist::GetAbilityToGrant() const
{
	return AbilityToGrant;
}

// Called when the game starts or when spawned
void ACountess_GAGrantingActor_Mist::BeginPlay()
{
	Super::BeginPlay();
}
