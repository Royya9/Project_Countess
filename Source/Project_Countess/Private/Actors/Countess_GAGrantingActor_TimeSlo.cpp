...
#include "Actors/Countess_GAGrantingActor_TimeSlo.h"
...
ACountess_GAGrantingActor_TimeSlo::ACountess_GAGrantingActor_TimeSlo()
{
	...
	AbilityToGrant = UCountess_GameplayAbility_TimeSlo::StaticClass();

	bAcquired_Ability = false;
}

void ACountess_GAGrantingActor_TimeSlo::AbilityAcquired(TSubclassOf<UCountess_GameplayAbility_Base> AcquiredAbility)
{
...
void ACountess_GAGrantingActor_TimeSlo::AbilityAcquiredEvent_Implementation()
{
	AbilityAcquiredEvent();
}

bool ACountess_GAGrantingActor_TimeSlo::IsAbilityAcquired() const
{
	return bAcquired_Ability;
}

UBoxComponent* ACountess_GAGrantingActor_TimeSlo::GetBoxComponent() const
{
	return BoxComponent_HardRef;
}

TSubclassOf<UCountess_GameplayAbility_Base> ACountess_GAGrantingActor_TimeSlo::GetAbilityToGrant() const
{
	return AbilityToGrant;
}

// Called when the game starts or when spawned
void ACountess_GAGrantingActor_TimeSlo::BeginPlay()
{
	Super::BeginPlay();
}
